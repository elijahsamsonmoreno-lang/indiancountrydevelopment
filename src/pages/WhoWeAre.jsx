...
const team = [
  {
    id: 'phil',
    name: 'Phil Gover',
    lead: 'Builds institutions, partnerships, and programs from scratch.',
    items: [
  ...
  },
  {
    id: 'elijah',
    name: 'Elijah Moreno',
    lead: 'Builds tools, datasets, and evidence where the field had gaps.',
    items: [
...
export default function WhoWeAre() {
  ...
  return (
    <>
      ...
      <main id="main">
        <ScrollReveal>
          <section className="section section--wide about-section" id="about">
