  ...
  return (
    <>
      <SEO
        title="Featured Work"
        path="/featured-work"
        description="Indian Country Development provides strategy & governance, programs & operations, and data & learning services for tribal governments and Native organizations."
